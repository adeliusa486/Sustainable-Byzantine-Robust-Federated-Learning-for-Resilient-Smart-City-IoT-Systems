...
PAPER = {
 "label_flipping": {
  "fedavg":       [94.3, 89.3, 73.8, 63.5],
  "trimmed_mean": [92.1, 91.4, 83.0, 73.3],
  "krum":         [89.7, 89.5, 87.3, 67.9],
  "fltrust":      [77.4, 74.6, 72.1, 70.3],
  "feddbc":       [92.1, 85.6, 72.0, 61.0],
  "amfta":        [93.1, 92.8, 80.3, 55.6],
  "amfta_noq":    [92.5, 92.3, 91.7, 70.9]},
 "gaussian_noise": {
  "fedavg":       [71.3, 40.8, 42.8, 38.9],
  "trimmed_mean": [94.4, 57.0, 41.5, 37.2],
  "krum":         [90.0, 89.9, 90.3, 71.4],
  "fltrust":      [77.3, 73.6, 70.3, 66.8],
  "feddbc":       [93.9, 92.8, 65.3, 52.1],
  "amfta":        [90.3, 89.5, 89.3, 74.6],
  "amfta_noq":    [90.9, 90.6, 90.6, 79.2]},
}
